...
<div align="center">
  ...
  ![GitHub repo size](https://img.shields.io/github/repo-size/chrisjameschamp/Project-Folder-Template?style=flat-square)
...
```sh
git clone https://github.com/chrisjameschamp/Project-Folder-Template.git
```
